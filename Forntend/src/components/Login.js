  ...
  return (
    <div className="body1">
      <div className="login-container">
        ...
        {form ? (
          <Login setform={setform} form={form} />
        ) : (
          <Signup setform={setform} form={form} />
        )}
      </div>
    </div>
  );
      ...
      <div className='left-t'>
        ...
        {serror && <div style={{ color: 'red', fontSize: '18px',position:"relative",left:'100px'}}>{serror}</div>}
          ...
          <div className="form-container1">
            ...
            <span style={{ margin: "0px", color: "white" }} className="login-f">
              Don't you have an account?
              <NavLink style={{ margin: "5px" }} onClick={hanlestate}>
                Sign up
              </NavLink>
            </span>
          </div>
        ...
        <div className="image-container1">
          <div className="right-t">
            ...
            <button className="create-btn" onClick={hanlestate}>
              Create an account
            </button>
          </div>
        </div>
